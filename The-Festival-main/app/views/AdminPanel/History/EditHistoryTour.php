            ...
            <div class="col-md-6 col-lg-6 col-xl-5">
                <div class="mb-3">
                    ...
                    <input type="text" name="artistName" id="artistName" class="form-control"
                           value="<?= $historyTour->getTourLanguage() ?>"/>
                </div>
                <div class="mb-3">
                    ...
                    <textarea name="artistDescription" id="artistDescription" class="form-control"
                              rows="8"><?= $historyTour->getHistoryTourLocations() ?></textarea>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="artistDescription">Description</label>
                    <textarea name="artistDescription" id="artistDescription" class="form-control"
                              rows="8"><?= $historyTour->getTourDate() ?></textarea>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="artistDescription">Description</label>
                    <textarea name="artistDescription" id="artistDescription" class="form-control"
                              rows="8"><?= $historyTour->getDuration() ?></textarea>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="artistDescription">Description</label>
                    <textarea name="artistDescription" id="artistDescription" class="form-control"
                              rows="8"><?= $historyTour->getTime() ?></textarea>
                </div>
                ...
                <div class="col-md-6 pb-5">
                    <div class="pt-3 d-flex justify-content-between">
                        <button type="reset" class="btn btn-secondary me-3"
                                onclick="location.href='/admin/history/historyTours'">
                            Cancel
                        </button>
<!--                        <button type="button"-->
<!--                                class="btn btn-primary ms-3"-->
<!--                                onclick="btnSaveChangesClicked('--><?//= $historyTour->getHistoryTourId() ?>//')">
//                            Save Changes
//                        </button>
                        <form method="POST">
                            <input type="hidden" name="getHistoryTourId" value="<?= $historyTour->getHistoryTourId() ?>" />
